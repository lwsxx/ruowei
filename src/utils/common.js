...
const isIPhoneX = Platform.OS === 'ios' && ((height === X_height && width === X_width) || (height === X_width && width === X_height)
    || (height === x11_width && width === x11_height) || (width === x11_width && height === x11_height));
// iphoneX 顶部留白的兼容处理
...
const _height = os === 'android' ? height-ExtraDimensions.getSmartBarHeight()-45 : height * 0.96;
const Constansts = {
    username: '', //用户名
    ...
    width: _width,
    height: _height,
    quanping:os === 'android' ? height : height * 0.96,
    os: os
    //...后续待加
}
...
export { Constansts ,keyGenerate,isJsonString};
